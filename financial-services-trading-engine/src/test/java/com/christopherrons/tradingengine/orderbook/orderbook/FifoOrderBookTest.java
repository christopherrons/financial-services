...
import static com.christopherrons.tradingengine.orderbook.EventCreatorUtils.buildMarketDataOrderCreate;
...
class FifoOrderBookTest {
    ...
    @BeforeEach
    void init() {
        this.fifoOrderBook = new FifoOrderBook("TEST");
    }

    @Test
    void testAddToOrderBook() {
        fifoOrderBook.addOrder(buildMarketDataOrderCreate(MARKET_DATA_FEED_ENUM, 0,
                100, 10, OrderTypeEnum.BUY, 1));
        fifoOrderBook.addOrder(buildMarketDataOrderCreate(MARKET_DATA_FEED_ENUM, 0,
                100, 10, OrderTypeEnum.BUY, 2));
        fifoOrderBook.addOrder(buildMarketDataOrderCreate(MARKET_DATA_FEED_ENUM, 2,
    ...
    void testUpdateOrderBook() {
        ...
        fifoOrderBook.updateOrder(buildMarketDataOrderCreate(MARKET_DATA_FEED_ENUM, 0,
    ...
    void testMatchingAlgorithmSamePriceLevel() {
        ...
        fifoOrderBook.addOrder(buildMarketDataOrderCreate(MARKET_DATA_FEED_ENUM, 3,
