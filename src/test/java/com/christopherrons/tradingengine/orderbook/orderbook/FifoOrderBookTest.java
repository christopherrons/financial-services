...
class FifoOrderBookTest {
    ...
    void testAddToOrderBook() {
        fifoOrderBook.addOrder(buildMarketDataOrderCreate(marketDataFeedEnum, 0,
                100, 10, OrderTypeEnum.BUY, 1));
        fifoOrderBook.addOrder(buildMarketDataOrderCreate(marketDataFeedEnum, 0,
                100, 10, OrderTypeEnum.BUY, 2));
        fifoOrderBook.addOrder(buildMarketDataOrderCreate(marketDataFeedEnum, 2,
    ...
    void testUpdateOrderBook() {
        ...
        fifoOrderBook.updateOrder(buildMarketDataOrderCreate(marketDataFeedEnum, 0,
    ...
    void testMatchingAlgorithmSamePriceLevel() {
        ...
        fifoOrderBook.addOrder(buildMarketDataOrderCreate(marketDataFeedEnum, 3,
